...
(function (ps_twitterUtils, $, undefined) {
	...
	ps_twitterUtils.buildWidgetModal = function () {
		...
		$("#modal_widget #modal-widget-body").html("<div id='news_header' class='newsHeader'>" + $("#div_tweeterStream .div_tweetsParent").html() + "</div>" + "<div id='news_header_admin' class='newsHeader'>" + $("#div_tweeterStream_admin .div_tweetsParent").html() + "</div>" + "<div id='div_mentionTweet'>" + $("#div_tweeterStream .div_tweetsParent").html() + "</div>" + "<div id='div_verizonTweet'>" + $("#div_tweeterStream_admin .div_tweetsParent").html() + "</div>");
