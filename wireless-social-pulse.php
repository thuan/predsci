    ...
    <div id="content">
        ...
        <div class="widget_container_holder barChartVS" id="volumeAndSentiment">
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="Sentiment of conversation for all Verizon Wireless data. Sentiment analysis conducted by Clarabridge with a score between -5 and +5."><i
                            class="icon-info-sign icon-white"></i></a>
                    <a id="launch-app" href="javascript:ps_modals.launch(widget_volumeandsentiment.modal);"><i
                            class="icon-resize-full icon-white"></i></a>
                </div>
            </div>
            ...
            <div class="widget_label">
                ...
                <div class="pull-right">
                    ...
                    <a id="tooltipp" href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="A United States map displaying Share of Voice by city for Verizon Wireless and key competitors. The color of a circle indicates the leading competitor for that city."><i
                            class="icon-info-sign icon-white"></i></a>
                    <a id="launch-app" href="javascript:ps_modals.launch(widgetConversationVolume.modal)"><i
                            class="icon-resize-full icon-white"></i></a>
            ...
            <div class="widget_label">
                ...
                <div class="pull-right">
                    ...
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="A United States map displaying Share of Voice by city for Verizon Wireless and key competitors. The color of a circle indicates the leading competitor for that city."><i
                            class="icon-info-sign icon-white"></i></a>
                    <a id="launch-app" href="javascript:ps_modals.launch(widgetPredefinedTopicVolume.modal)"><i
                            class="icon-resize-full icon-white"></i></a>
                </div>
            </div>
        ...
        <div class="widget_container_holder" id="twitterStream">
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="A stream of tweets related to Verizon Wireless.">
        ...
        <div class="widget_container_holder_long">
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="The most engaging Tweets from the Verizon Wireless Twitter handles. Engagement is based on Retweets and @Replies."><i
                            class="icon-info-sign icon-white"></i></a>
                    <a href="#" id="launch-app"><i class="icon-resize-full icon-white" data-toggle="modal"
                                                   data-target=".twitterModal"></i></a>
        ...
        <div id="twitterModal" class="modal hide fade twitterModal" tabindex="-1" role="dialog"
             aria-labelledby="twitterModalLabel" aria-hidden="true">
            <div class="modal-header">
                <div id="right-side">
                    <a id="icon-info" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="The most engaging Tweets from the Verizon Wireless Twitter handles. Engagement is based on Retweets and @Replies."><i
                            class="icon-info-sign icon-white"></i></a>
        ...
        <div class="widget_container_holder barChartVS" id="sentimentCompetitors">
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="Volume of positive, negative, and neutral sentiment for Verizon Wireless and key competitors."><i
                            class="icon-info-sign icon-white"></i></a>
                    <a id="launch-app" href="javascript:ps_modals.launch(widget_sentimentCompetitors.modal);"><i
                            class="icon-resize-full icon-white"></i></a>
                </div>
            </div>
        ...
        <div class="box kList widget_container_holder_keyword">
            ...
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="Top keywords for Verizon Wireless network by volume of conversation."><i
                            class="icon-info-sign icon-white"></i></a>
                </div>
            </div>
            <div class="row-fluid">
        ...
        <div class="widget_container_holder" id="trending_terms">
            <div class="widget_label">
                ...
                <div class="pull-right">
                    <a href="#" data-toggle="tooltip" data-placement="top" title=""
                       data-original-title="Sentiment of conversation for all Verizon Wireless data. Sentiment analysis conducted by Clarabridge with a score between -5 and +5.">
