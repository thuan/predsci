...
<head>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=true&libraries=drawing"></script>



    <link href="/css/bootstrap/bootstrap.min.css" type="text/css" rel="stylesheet" />
    <link href="/css/bootstrap/jquery.dataTables.css" type="text/css" rel="stylesheet" />
    ...
    <!-- JChart -->
    <link rel="stylesheet" type="text/css" href="/css/jchart/jChartFX/jchartfx.css" />
    ...
    <script src="/js/psgooglemaps.js"></script>

    <!-- <script language="javascript" src="/lib/jchart/jchartfx.lic.js" type="text/javascript"></script> -->
