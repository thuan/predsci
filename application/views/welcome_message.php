        ...
        <div id="dashboard_content">
            ...
            <div id="linkedinFollowers" class="widget_container_holder linkedinFollowers">
                <div class="widget_label">
                    ...
                    <div class="pull-right">
                        ...
                        <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Volume of followers over time for the Verizon Enterprise Solutions company page on LinkedIn.">
                            <i class="icon-info-sign icon-white"></i>
                        </a>
                        <a id="launch-app" href="javascript:ps_modals.launch(widgetLinkedinFollowers.modal)">
                            <i class="icon-resize-full icon-white"></i>
                        </a>
                    </div>
                </div>
            ...
            <div id="linkedInLikes" class="widget_container_holder linkedInLikes">
                <div class="widget_label">
                    ...
                    <div class="pull-right">
                        <a href="javascript:ps_utilities.toggleBarLine(widgetLinkedinLikes)">
                            <i class="icon line-swap"></i>
                        </a>
                        <a id="tooltipp" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="A United States map displaying Share of Voice by city for Verizon Wireless and key competitors. The color of a circle indicates the leading competitor for that city.">
                            <i class="icon-info-sign icon-white"></i>
                        </a>
                        <a id="launch-app" href="javascript:ps_modals.launch(widgetLinkedinLikes.modal)">
                            <i class="icon-resize-full icon-white"></i>
                        </a>
                    </div>
                </div>
